...
HD_PWD='C:/Users/NEEL/Downloads/verilog/Sequential Circuits/master_slave_ff/master_slave_ff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m_s_ff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m_s_ff.tcl -notrace
