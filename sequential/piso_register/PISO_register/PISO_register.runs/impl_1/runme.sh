...
HD_PWD='C:/Users/NEEL/Downloads/verilog/Sequential Circuits/PISO_register/PISO_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PISO_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PISO_register.tcl -notrace
