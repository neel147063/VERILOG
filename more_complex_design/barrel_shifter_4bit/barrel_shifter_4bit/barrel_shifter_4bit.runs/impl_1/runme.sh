...
HD_PWD='C:/Users/NEEL/Downloads/verilog/More  Complex Designs/barrel_shifter_4bit/barrel_shifter_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_shifter_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source barrel_shifter_4bit.tcl -notrace
