...
HD_PWD='C:/Users/NEEL/Downloads/verilog/memory circuit/FIFO_RAM/FIFO_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_RAM.tcl
