...
HD_PWD='C:/Users/NEEL/Downloads/verilog/More  Complex Designs/barrel_shifter_4bit/barrel_shifter_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_shifter_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source barrel_shifter_4bit.tcl
