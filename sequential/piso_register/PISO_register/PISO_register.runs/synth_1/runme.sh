...
HD_PWD='C:/Users/NEEL/Downloads/verilog/Sequential Circuits/PISO_register/PISO_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PISO_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PISO_register.tcl
