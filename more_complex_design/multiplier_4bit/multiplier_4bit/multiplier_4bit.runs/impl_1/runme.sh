...
HD_PWD='C:/Users/NEEL/Downloads/verilog/More  Complex Designs/multiplier_4bit/multiplier_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_4bit.tcl -notrace
