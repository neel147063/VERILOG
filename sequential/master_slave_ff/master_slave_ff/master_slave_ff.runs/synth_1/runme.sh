...
HD_PWD='C:/Users/NEEL/Downloads/verilog/Sequential Circuits/master_slave_ff/master_slave_ff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_s_ff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_s_ff.tcl
