...
HD_PWD='C:/Users/NEEL/Downloads/verilog/More  Complex Designs/multiplier_4bit/multiplier_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_4bit.tcl
