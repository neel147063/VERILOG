...
HD_PWD='C:/Users/NEEL/Downloads/verilog/memory circuit/FIFO_RAM/FIFO_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFO_RAM.tcl -notrace
